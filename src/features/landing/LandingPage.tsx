...
const FEATURES = [
  ...
  },
  {
    ...
    desc:  "Plan and document every session, track packages, manage billing, and send automated WhatsApp reminders.",
  },
  {
    icon: "📊",
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .lp-plan-card {
          ...
          padding: 32px; display: flex; flex-direction: column; gap: 0; position: relative;
          transition: all 0.2s;
        }
        .lp-plan-card.popular {
          border-color: #2E8BC0;
          box-shadow: 0 8px 32px rgba(46,139,192,0.12);
        }
        .lp-popular-badge {
