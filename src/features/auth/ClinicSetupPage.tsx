...
export default function ClinicSetupPage() {
  ...
  const inp: React.CSSProperties = { width: "100%", padding: "11px 14px", border: "1.5px solid #e5e0d8", borderRadius: 10, fontFamily: "'Outfit', sans-serif", fontSize: 14, color: "#1a1a1a", outline: "none", boxSizing: "border-box" };
    ...
    <div style={{ minHeight: "100vh", background: "#f5f8fc", fontFamily: "'Outfit', sans-serif", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ background: "#fff", borderRadius: 24, padding: 40, width: "100%", maxWidth: 460, boxShadow: "0 8px 40px rgba(0,0,0,0.08)" }}>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <input style={inp} placeholder="e.g. Cairo Physio Center" value={clinicName}
            onChange={(e) => setClinicName(e.target.value)} autoFocus />
        </div>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <div style={{ position: "relative" }}>
            <span style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", fontSize: 12, color: "#9a9590", pointerEvents: "none" }}>/c/</span>
            <input
              style={{ ...inp, paddingLeft: 36, borderColor: slugOk === true ? "#22c55e" : slugOk === false ? "#ef4444" : "#e5e0d8" }}
              value={slug}
        ...
        <div style={{ marginBottom: 28 }}>
          <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "#5a5550", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 6 }}>Plan</label>
        ...
        <div style={{ textAlign: "center", marginTop: 16 }}>
          <button style={{ background: "none", border: "none", fontSize: 13, color: "#9a9590", cursor: "pointer" }} onClick={() => navigate("/login")}>
            Back to login
          </button>
        </div>
      </div>
